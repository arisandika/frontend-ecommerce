...
!(function (n, t, e) {
  ...
  function c(n, t) {
    ...
    return (
      ...
      e.acos(
        e.min(
          c(r) * c(u) * c(i) * c(a) + c(r) * s(i) * c(u) * s(a) + s(r) * s(u),
          1
        )
      )
    );
  ...
  function g(n) {
    ...
    return (
      ...
      p("Geocoder").geocode(n, function (n, e) {
        e === k.GeocoderStatus.OK
          ? t.resolve(n[0].geometry.location)
          : t.reject();
      }),
      t
    );
  ...
  function x(n, t) {
    return R(n)
      ? new k.LatLng(n[0], n[1])
      : !t || !n || n instanceof k.LatLng
      ? n
      : new k.LatLng(n.lat, n.lng);
  }
  function P(n, t) {
    return R(n)
  ...
  function b(t, o) {
    ...
    return (
      (o = j({ x: 0, y: 0 }, o)),
      o.position
        ? (o.position = x(o.position, !0))
        : o.bounds && (o.bounds = P(o.bounds, !0)),
      (r.prototype = new i()),
      new r()
    );
  }
  function M(n) {
    function t() {
      var n = this;
      return (
        (n.onAdd = n.onRemove = n.draw = function () {}), k.OverlayView.call(n)
      );
    }
  ...
  function C(n, t) {
    ...
    function u() {
      ...
      (p = "" + d),
        d > 3 &&
          ((a = e()),
          h(w, function (n, t) {
            a.contains(n.getPosition()) ||
              ((p += "-" + t), (P[t] = !0), n.getMap() && n.setMap(null));
          })),
        m &&
          h(w, function (n, t) {
            P[t] ||
    ...
    function s() {
      k.event.addListener(n, "zoom_changed", a),
        k.event.addListener(n, "bounds_changed", a),
        u();
    }
    var f,
      p,
        ...
        n.each(t, function (n, t) {
          h(e, function (e) {
            var a = e instanceof B,
              ...
              f = s ? e.$.get(0) : e;
            k.event["add" + (s ? "Dom" : "") + "Listener" + (i ? "Once" : "")](
              f,
              n,
              function (n) {
                h(t, function (t) {
